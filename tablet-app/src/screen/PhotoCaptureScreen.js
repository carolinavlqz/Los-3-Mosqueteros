...
export default function PhotoCaptureScreen() {
  ...
  const renderCaptureBox = (field, photo, label) => (
    <TouchableOpacity
      style={[
        s.captureBox, 
        useRowLayout && s.captureBoxRow, 
        photo && s.captureBoxFilled
      ]}
      activeOpacity={0.85}
...
const createStyles = (scale) =>
  StyleSheet.create({
    ...
    captureBox: { 
      aspectRatio: 1, 
      maxHeight: 280, // Evita que se vuelva gigante en tablets o pantallas anchas
      borderWidth: 2, 
      borderColor: '#e2e8f0', 
      borderStyle: 'dashed', 
      borderRadius: 18, 
